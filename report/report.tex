...
{\large \textbf{GVHD:} TS. Nguyễn Hữu Du}

\vspace{0.55cm}
{\large \textbf{Sinh viên thực hiện: Lớp 169317}}
...
Báo cáo gồm 6 chương: Chương 2 trình bày cơ sở lý thuyết (các mô hình dự báo và tối ưu tồn kho); Chương 3 mô tả dữ liệu, tiền xử lý và phương pháp; Chương 4 trình bày kết quả thực nghiệm, \textit{so sánh các mô hình} và khuyến nghị quyết định; Chương 5 nêu hạn chế và định hướng phát triển; Chương 6 trình bày khối lượng công việc thực hiện.
...
% ==================== CHƯƠNG 6: KHOI LUONG CONG VIEC ====================
\chapter{Khối lượng công việc thực hiện}

Đồ án do một sinh viên thực hiện toàn bộ. Các hạng mục công việc chính cùng minh chứng tương ứng (mã nguồn, hình/bảng trong báo cáo) được liệt kê ở Bảng~\ref{tab:phancong}.

\begin{table}[H]
\centering
\caption{Khối lượng công việc và minh chứng}
\label{tab:phancong}
\renewcommand{\arraystretch}{1.35}
\begin{tabular}{|>{\raggedright\arraybackslash}p{0.58\linewidth}|>{\raggedright\arraybackslash}p{0.32\linewidth}|}
\hline
\rowcolor{gray!18}
\textbf{Hạng mục công việc} & \textbf{Minh chứng} \\
\hline
Thu thập, tiền xử lý dữ liệu và phân tích khám phá (EDA) & \texttt{Data/}, EDA (Ch.~3) \\
\hline
Xây dựng mô hình dự báo (RevIN, N-BEATS) và 4 mô hình so sánh; huấn luyện, tối ưu siêu tham số bằng Optuna, so sánh top-5 & \texttt{src/}, hình 4.1--4.4, bảng 4.2 \\
\hline
Mô hình tối ưu tồn kho (Newsvendor, EOQ) & \texttt{inventory.py} \\
\hline
Triển khai ứng dụng web và viết báo cáo & \texttt{app/}, báo cáo \\
\hline
\end{tabular}
\end{table}

Sinh viên thực hiện: \textbf{Nguyễn Trường Giang} (MSSV 20227044), lớp 169317.
